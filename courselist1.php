...
<?php
        ...
        $s="select b.ctgid,a.coursenm,a.duration,a.fees, a.courseimg from mstcourse as a inner join mstcategory as b ON a.ctgid=b.ctgid order by b.ctgnm,a.coursenm";
    ...
    <table align="center" bgcolor="yellow" border="2"> 
             <tr>
                 <td>Category Name</td>
                 <td>Course Name</td><!-- comment -->
                 <td>Duration</td><!-- comment -->
                 <td>Fees</td><!-- comment -->
                 <td>Course img</td>
             </tr>    
          <?php   
